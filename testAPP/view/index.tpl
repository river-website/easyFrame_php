...
<div class="box">
    ...
    <div class="header">
        <div class="header-auto">
            <h2 class="header-left">
                <a title="百度云下载" href="http://www.baiduyunpan.com/">
                    <img alt="百度云下载" src="http://www.baiduyunpan.com/images/logo.png" data-bd-imgshare-binded="1"></a>
            </h2>
    ...
    <div class="nav">
        <div class="nav-auto">
            <ul>
                <li class="nav-li nav-li2"><a href="http://www.baiduyunpan.com/">百度云搜索</a></li>
                <li class="nav-li"><a href="http://www.baiduyunpan.com/new/">百度云下载</a></li>
                <li class="nav-li"><a href="http://www.baiduyunpan.com/movie/全部-全部-0.html">百度云电影</a></li>
                <li class="nav-li"><a href="http://www.baiduyunpan.com/users/">百度云会员</a></li>
                <li class="nav-li"><a href="http://www.baiduyunpan.com/articlelist/">百度云资源</a></li>
                <li class="nav-li"><a href="http://www.baiduyunpan.com/album/">百度云专辑</a></li>
            </ul>
        </div>
    </div>
    <!-- 图片轮播广告 -->
    ...
    <div class="search" style="margin-top:10px;">
        ...
        <div class="search-auto">
            <div class="search-wrap">
                <a href="#" class="search-wrap-a wrap-a2" id="0">全部</a>
                <a href="#" class="search-wrap-a" id="1">视频</a>
                <a href="#" class="search-wrap-a" id="2">音频</a>
                <a href="#" class="search-wrap-a" id="3">种子</a>
                <a href="#" class="search-wrap-a" id="4">软件</a>
                <a href="#" class="search-wrap-a" id="5">图片</a>
                <a href="#" class="search-wrap-a" id="6">文档</a>
                <a href="#" class="search-wrap-a" id="7">压缩包</a>
            </div>
            ...
            <form id="form1" class="search_form">
                ...
                <i class="form-i"><img src="http://www.baiduyunpan.com/images/1.png" id="indextest" onclick="searchyun();" data-bd-imgshare-binded="1"></i>
            </form>
    ...
    <div class="ranklist">
        <div class="ranklist-left">
            <div class="ranklist-left-rm">
                ...
                <p class="rm-p"><a href="http://www.baiduyunpan.com/searchhot/0.html" target="_blank">更多&gt;</a></p>
            </div>
            <div class="left-rm-center">
                <ul>
                    ...
                    <li class="rm-center-li">
                        ...
                        <a target="_blank" href="http://www.baiduyunpan.com/search/快穿妖女-0-全部-0.html">快穿妖女</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="ranklist-xz">
            <div class="ranklist-xz-tj">
                ...
                <p class="rm-p"><a target="_blank" href="http://www.baiduyunpan.com/searchkeyhot/0.html">更多&gt;</a></p>
            </div>
            <div class="xz-tj-center">
                <ul>
                    <li class="tj-center-li">
                        <a target="_blank" href="http://www.baiduyunpan.com/search/三浦展-0-全部-0.html">三浦展</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="ranklist-yp">
            <div class="ranklist-yp-dt">
                ...
                <p class="rm-p"><a target="_blank" href="http://www.baiduyunpan.com/articlelist/">更多&gt;</a></p>
            </div>
            <div class="yp-dt-center">
                <ul>

                    <li class="dt-center-li">
                        <a target="_blank" href="http://www.baiduyunpan.com/article/113034.html">【第432期】中国历史故事——老师中的老师（第3册）</a>
    ...
    <!--
     ...
     <div class="member-top">
      ...
      <p class="rm-p"><a target="_blank" href="http://www.baiduyunpan.com/ztlist/1.html">更多></a></p>
     </div>
     <div class="zxrmzt-div">
       <a href="http://www.baiduyunpan.com/zt/三浦展-三浦展.html" class="zxrmzt-a" target="_blank">三浦展</a>
     </div>
    ...
    <div class="member">
        <div class="member-top">
            ...
            <p class="rm-p"><a target="_blank" href="http://www.baiduyunpan.com/users/">更多&gt;</a></p>
        </div>
        <div class="member-img">
            <ul>
                <li class="member-img-li">
                    <a target="_blank" href="http://www.baiduyunpan.com/user/3826276867-0-0.html">
                        <img alt="zouzou313414" src="http://himg.bdimg.com/sys/portrait/item/14e4dc14.jpg" data-bd-imgshare-binded="1"></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="resource">
        <div class="resource-top">
            ...
            <p class="rm-p"><a target="_blank" href="http://www.baiduyunpan.com/new/">更多&gt;</a></p>
        </div>
        ...
        <div class="resource-centerx">
            <ul>
                <li class="resource-conter-li resource-li7">
                    ...
                    <a target="_blank" href="http://www.baiduyunpan.com/file/28088502.html">西谎极落之太爆太子太空舱 2017</a>
                </li>
                <li class="resource-conter-li resource-li3 li6"><label></label>2017-09-24<span>|</span></li>
                <li class="resource-conter-li li6">
                    -
                    <span>|</span></li>
                <li class="resource-conter-li resource-li3 li6">1215次<span>|</span></li>
                <li class="resource-conter-li li6"><img class="resource-img" src="http://www.baiduyunpan.com/images/20.png" alt="百度云下载" data-bd-imgshare-binded="1"><span>|</span></li>
                <li class="resource-conter-li resource-li5 li6"><a href="http://www.baiduyunpan.com/user/3242663843-0-0.html" target="_blank">电影**分享</a></li>
       ...
       <div class="search-images resource-imsges">
         <a title="" target="_blank" href="javascripr:;">
          <img alt="" src="http://www.baiduyunpan.com/images/25.png"/></a>
        </div>
        -->
    </div>
    ...
    <div class="member syjq">
        ...
        <div class="stjq-div">
            <div class="stjq-left">
                <ul>
                    <li class="stjq-left-li">
                        <a target="_blank" href="http://www.baiduyunpan.com/file/27487497.html">百度云网盘使用教程.pdf</a>
                    </li>
                </ul>
            </div>
            <div class="stjq-left">
                <ul>
                    <li class="stjq-left-li">
                        <a target="_blank" href="http://www.baiduyunpan.com/file/27016275.html">百度云盘使用教程.docx</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="stjq-left">
                <ul>
                    <li class="stjq-left-li">
                        <a target="_blank" href="http://www.baiduyunpan.com/file/27209810.html">如何使用百度云.docx</a>
                    </li>
                </ul>
            </div>
        </div>
